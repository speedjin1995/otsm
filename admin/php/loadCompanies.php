...
$searchQuery = " ";
if($searchValue != ''){
  $searchQuery = "AND (name like '%".$searchValue."%' or reg_no like '%".$searchValue."%')";
}

## Total number of records without filtering
$sel = mysqli_query($db2,"select count(*) as allcount from companies");
$records = mysqli_fetch_assoc($sel);
$totalRecords = $records['allcount'];

## Total number of record with filtering
$sel = mysqli_query($db2,"select count(*) as allcount from companies".$searchQuery);
$records = mysqli_fetch_assoc($sel);
