    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" id="sideMenu" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!--li class="nav-item">
            <a href="#scale" data-file="scale.php" class="nav-link link">
          ...
          <!--li class="nav-item">
            <a href="#licenses" data-file="licenses.php" class="nav-link link">
          ...
          <li class="nav-item">
            <a href="#staffs" data-file="staffs.php" class="nav-link link">
