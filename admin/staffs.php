        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-6"></div>
              <div class="col-6">
                <button type="button" class="btn btn-block bg-gradient-warning btn-sm" id="addMembers">Add Staffs</button>
              </div>
            </div>
          </div>
          <div class="card-body">
...
$(function () {
    ...
    $.validator.setDefaults({
        submitHandler: function () {
          $('#spinnerLoading').show();
          $.post('php/staffs.php', $('#memberForm').serialize(), function(data){
...
function edit(id){
    $('#spinnerLoading').show();
    $.post('php/getStaff.php', {userID: id}, function(data){
        var obj = JSON.parse(data);
...
function deactivate(id){
    if (confirm('Are you sure you want to delete this items?')) {
        $('#spinnerLoading').show();
        $.post('php/deleteStaff.php', {userID: id}, function(data){
            var obj = JSON.parse(data);
