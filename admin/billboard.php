...
if(!isset($_SESSION['userID'])){
    ...
    $customers = $db2->query("SELECT * FROM companies WHERE deleted = '0' ORDER BY name");
}
?>
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Weighing Records</h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
      ...
      <div class="col-lg-12">
        <div class="card card-primary">
          <div class="card-header">
            <div class="row">
              <div class="col-10">Weighing Records</div>
              <!--div class="col-2">
...
$(function () {
  ...
  $('#daterange-btn').daterangepicker(
    ...
    function (start, end) {
      var startFormatted = formatDate2(new Date(start));
      var endFormatted = formatDate2(new Date(end));
      ...
      table = $("#weightTable").DataTable({
        ...
        'columns': [
          ...
          { data: 'end_time' },
          {
            data: 'id',
            render: function (data, type, row) {
              return '<div class="row"><div class="col-3"><button type="button" id="print' + data + '" onclick="window.open(\'https://dglink.com.my/chickenweigher/print.php?userID=' + data + '\');" class="btn btn-info btn-sm"><i class="fas fa-print"></i></button></div><div class="col-3"><button type="button" id="print2' + data + '" onclick="window.open(\'https://dglink.com.my/chickenweigher/printportrait.php?userID=' + data + '\');" class="btn btn-success btn-sm"><i class="fas fa-receipt"></i></button></div><div class="col-3"></div><div class="col-3"></div></div>';
            }
          }
        ],
