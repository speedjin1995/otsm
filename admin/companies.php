            ...
            <div class="modal-body">
              <div class="card-body">
                ...
                <div class="form-group"> 
                  ...
                  <input type="text" class="form-control" id="fax" name="fax" placeholder="Enter your Fax No">
                </div>
                <div class="form-group"> 
                ...
                <div class="form-group"> 
                  <label for="website">Number of Farms *</label>
                  <input type="text" class="form-control" id="farm_no" name="farm_no" placeholder="Enter your Number of Farms" required>
                </div>
                <div class="form-group">
                  <label for="products">Type</label>
                  <select class="select2" style="width: 100%;" id="type" name="type" required> 
                    <option value="OWN">OWN</option>
                    <option value="CONTRACT">CONTRACT</option>
                  </select>
                </div>
                <div class="form-group">
                  <label for="products">Parent</label>
                  <select class="select2" style="width: 100%;" id="companies" name="companies"> 
...
$(function () {
    ...
    $('#addSuppliers').on('click', function(){
        ...
        $('#addModal').find('#website').val("");
        $('#addModal').find('#products').select2('destroy').val('').select2();
        $('#addModal').find('#farm_no').val("1");
        $('#addModal').find('#type').val("OWN");
        $('#addModal').find('#companies').val("");
        $('#addModal').modal('show');
...
function edit(id){
    ...
    $.post('php/getCompany.php', {userID: id}, function(data){
        ...
        if(obj.status === 'success'){
            ...
            $('#addModal').find('#website').val(obj.message.website);
            $('#addModal').find("select[name='products[]']").val(obj.message.products).trigger('change');
            $('#addModal').find('#farm_no').val(obj.message.farms_no);
            $('#addModal').find('#type').val(obj.message.type).trigger('change');
            $('#addModal').find('#companies').val(obj.message.parent).trigger('change');
            $('#addModal').modal('show');
